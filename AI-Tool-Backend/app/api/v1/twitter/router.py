...
# Named matching the module export requirement from __init__.py
twitter_router = APIRouter(prefix="/twitter", tags=["Twitter Platform"])
...
@twitter_router.get("/login", response_model=TwitterLoginResponse)
...
@twitter_router.get("/callback", response_model=TwitterAccountResponse)
...
@twitter_router.get("/accounts", response_model=TwitterAccountListResponse)
...
@twitter_router.delete("/accounts/{account_id}", response_model=TwitterAccountDisconnectResponse)
...
@twitter_router.post("/media/upload", response_model=MediaUploadResponse, status_code=status.HTTP_201_CREATED)
...
@twitter_router.post("/post", response_model=TweetResponse, status_code=status.HTTP_201_CREATED)
...
@twitter_router.post("/post/thread", response_model=ThreadResponse, status_code=status.HTTP_201_CREATED)
...
@twitter_router.post("/post/schedule", response_model=ScheduledPostResponse, status_code=status.HTTP_201_CREATED)
...
@twitter_router.get("/analytics/{tweet_id}", response_model=TweetAnalyticsResponse)
...
@twitter_router.get("/analytics/thread/{post_id}", response_model=ThreadAnalyticsResponse)
